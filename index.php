    ...
    <div class="container">
                        ...
                        echo '
                                    <div class="box">
                                        <a href="thucdon.php?id_category=' . $item['id'] . '">
                                            <p>' . $item['name'] . '</p>
                                            <div class="bg"></div>
                                            <img src="images/bg/cake.jpg" alt="">
                                        </a>
                                    </div>
                                    ';
                    }
        ...
        <section class="main">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại quán <span class="green" style="color: pink;">Văn Lang Bakery</span></h1>
                </div>
                    ...
                    <div class="pagination" >
                        <ul>
                            ...
                            for ($i = 1; $i <= $current_page; $i++) {
                                ...
                                if ($i == $current_page) {
                                    echo '
                                    <li style="background-color: #FF99CC" ><a href="?page=' . $i . '">' . $i . '</a></li>';
                                } else {
                                    echo '
                                    <li style="background-color: #FF99CC" ><a href="?page=' . $i . '">' . $i . '</a></li>';
                                }
